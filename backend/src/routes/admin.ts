...
adminRouter.get('/transcripts', async (req, res) => {
...
adminRouter.patch('/transcripts/:id/status', async (req, res) => {
...
adminRouter.post('/transcripts/:id/upload-certificate', upload.single('certificate'), async (req, res) => {
...
adminRouter.get('/certificate-requests', async (req, res) => {
  const status = z.string().optional().parse(req.query.status);
...
adminRouter.patch('/certificate-requests/:id/status', async (req, res) => {
...
adminRouter.post('/certificate-requests/:id/upload-certificate', upload.single('certificate'), async (req, res) => {
  if (!req.file) return res.status(400).json({ error: 'certificate file is required' });
